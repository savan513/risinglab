...
export default function DiamondsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 dark:bg-gray-950/50 pt-20">
      {/* Hero Banner */}
      <div className="relative h-[300px]">
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href={`/`} className="block"> ← </Link> DIAMONDS
            </h1>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {fetchDiamondCategoryData.map((diamond) => (
            <div key={diamond._id} className="group relative">
              ...
              <div className="mt-4 space-y-2">
                <div className="text-sm text-gold">{diamond.category}</div>
                <Link href={`/diamond/${diamond.slug}`} className="block">
