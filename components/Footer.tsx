...
import { Facebook, Instagram, Youtube, MapPin, Phone, Mail, Gem } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-3 flex flex-col items-center lg:items-start">
            <Link href="/" className="block mb-6 transform hover:scale-105 transition-transform">
              <Image
            ...
            <p className="text-muted-foreground text-sm mb-6 text-center lg:text-left max-w-sm">
              All The Rise Of Lab Grown Diamonds products are ethically sourced and certified. Our commitment to sustainability and quality defines our legacy.
            </p>
          ...
          <div className="sm:col-span-2 lg:col-span-3">
            <h3 className="font-serif text-lg mb-4 text-center lg:text-left font-semibold">DIAMONDS</h3>
          ...
          <div className="sm:col-span-2 lg:col-span-3">
            <h3 className="font-serif text-lg mb-4 text-center lg:text-left font-semibold">JEWELLERY</h3>
            <ul className="space-y-3 text-center lg:text-left">
          ...
          <div className="sm:col-span-2 lg:col-span-3">
            <h3 className="font-serif text-lg mb-4 text-center lg:text-left font-semibold">QUICK LINKS</h3>
            <ul className="space-y-3 text-center lg:text-left">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
        ...
        <div className="mt-12 pt-8 border-t border-gold/50">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex items-center justify-center lg:justify-start space-x-3 text-sm text-muted-foreground group hover:text-foreground transition-colors">
              ...
              <span>+91 97248 20911</span>
            </div>
            <div className="flex items-center justify-center lg:justify-start space-x-3 text-sm text-muted-foreground group hover:text-foreground transition-colors">
              <Mail className="h-5 w-5 text-blue-500 group-hover:scale-110 transition-transform" />
              <a href="mailto:info@theriseofdiamonds.com" className="hover:underline">
                info@theriseofdiamonds.com
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gold/50 text-center">
          <p className="text-sm text-muted-foreground flex items-center justify-center gap-1">
            The Rise Of Lab Grown Diamonds © {new Date().getFullYear()} | Built with
            <span><Gem className="w-4 h-4 text-gold" /> </span>by WebPearl
          </p>
        </div>
      </div>
    </footer>
